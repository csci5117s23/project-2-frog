...
export default function NewSpecies() {
	...
	return (
		<div className='container'>
			...
			<div className='field'>
				<label className='label' htmlFor='commonName'>
					Common Name:{' '}
				</label>
				<div className='control'>
					<input
			...
			<div className='field'>
				<label className='label' htmlFor='wateringDays'>
			...
			<div className='field'>
				<label className='label' htmlFor='tempLevel'>
					Temperature Range(&#8457;):{' '}
				</label>
				<div className='control'>
					<input
			...
			<div className='control'>
				<button className='button' onClick={submit} value='submit'>
					submit
				</button>
			</div>
		</div>
