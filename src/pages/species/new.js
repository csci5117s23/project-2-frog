    ...
    return (<div className="container">
        ...
        <div className='field'>
            ...
            <div className='control'>
                <input className='input' id='scientificName' value={scientificName} 
                    onChange={(e)=>setScientificName(e.target.value)}></input>
            </div>
        </div>
        <div className='field'>
            <label className='label' htmlFor='commonName'>Common Name: </label>
            <div className='control'>
                <input className='input' id='commonName' value={commonName} 
                    onChange={(e)=>setCommonName(e.target.value)}></input>
            </div>
        </div>
        <div className='field'>
            <label className='label' htmlFor='description'>Description: </label>
            <div className='control'>
                <textarea className='textarea' id='description' value={description} 
        ...
        <div className='field'>
            ...
            <div className='control'>
                <input className='input' type='number' id='wateringDays' value={wateringDays} 
                    onChange={(e)=>setWateringDays(e.target.value)}></input>
            </div>
        </div>
        <div className='field'>
